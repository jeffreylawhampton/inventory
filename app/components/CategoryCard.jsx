...
const CategoryCard = ({ category, handleFavoriteClick }) => {
  return (
    <Card
      classNames={{
        root: "@container hover:brightness-90 !p-3 !rounded-md",
      }}
      styles={{
        root: {
    ...
    >
      ...
      <div className="flex flex-col @2xs:flex-row gap-x-0 gap-y-3 w-full @xs:justify-between @2xs:items-center h-full">
